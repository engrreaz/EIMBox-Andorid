...
.vertical-timeline-element-content:after {
   ...
   .lnk-text{display:inline-block; padding:7px 7px; font-size:15px; font-weight:700; text-transform:uppercase;}
        ...
        <div class="main-card mb-1 card">
            <div class="card-header"><b>Notice Board</b></div>
            <div class="card-body">
                <div class="vertical-timeline vertical-timeline--animate vertical-timeline--one-column">
                    <div class="vertical-timeline-item vertical-timeline-element">
                        <div>
                            ...
                            <span class="vertical-timeline-element-icon bounce-in ">
                                <i class="badge badge-dot badge-dot-xl holiday badge-success "></i>
                            </span>
                            <div class="vertical-timeline-element-content bounce-in">
                                <h4 class="timeline-title holiday-text">Durgapuja</h4>
                                <p>Sunday, 22 October, 2023<a href="javascript:void(0);" data-abc="true"></a></p>
                            </div>
                        </div>
                    </div>
                    <div class="vertical-timeline-item vertical-timeline-element">
                        <div>
                            ...
                            <span class="vertical-timeline-element-icon bounce-in ">
                                <i class="badge badge-dot badge-dot-xl badge-success"   style="background:teal;"></i>
                            </span>
                            <div class="vertical-timeline-element-content bounce-in">
                                <h4 class="timeline-title exam-text">Annual Examination</h4>
                                <p>Sunday, 5 November, 2023<a href="javascript:void(0);" data-abc="true"></a></p>
                            </div>
                        </div>
  ...
  <path d="M4.176 9.032a.5.5 0 0 0-.656.327l-.5 1.7a.5.5 0 0 0 .294.605l4.5 1.8a.5.5 0 0 0 .372 0l4.5-1.8a.5.5 0 0 0 .294-.605l-.5-1.7a.5.5 0 0 0-.656-.327L8 10.466 4.176 9.032Z"/>
                   ...
                   <div class="lnk-text" style="">About Us</div></div>
            </a>
        </div>
  ...
  <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"/>
                   ...
                   <div class="lnk-text" style="">Address</div></div>
            </a>
        </div>
