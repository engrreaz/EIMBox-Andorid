        <div class="card gg" style="display:none;" >
            <div class="card-header" style="color:var(--lighter); background:var(--dark); border-radius:0;"><b>Admission Test</b></div>
            <div class="card-body" onclick="goclsp();">
                <table width="100%">
                    <tr>
                        <td><a class="btn btn-dark" style="border-radius: 7px;" href="admissionassess.php?sec=Joba">JOBA</a></td>
                        <td><a class="btn btn-dark" style="border-radius: 7px;" href="admissionassess.php?sec=Beli">BELI</a></td>
                        <td>&nbsp;&nbsp;&nbsp;</td>
...
<?php
    ...
    {while($row00 = $result00->fetch_assoc()) { 
        ...
        <div class="card gg" >
            <div class="card-header" style="color:var(--lighter); background:var(--dark); border-radius:0;">
            ...
            <div class="card-body" >
                <div style="float:right; position:absolute; right:20px; top:60px;">
                    <svg onclick="addnew();" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="var(--dark)" class="bi bi-currency-exchange" viewBox="0 0 16 16">
                    ...
                    <svg  onclick="addnew2();"  style="margin-left:10px;" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="var(--dark)" class="bi bi-bank2" viewBox="0 0 16 16">
                ...
                <div>
                    <table width="100%">
                        <tr>
                            <td>
                                <div onclick="gocashbook();" class="nmbr"><small>BDT </small><span id="dues"><?php  echo number_format($netbalance,2,".",",");?></span></div>
                                <small>
            ...
            <div id="entrybox" style="margin:15px; display:none;">
                <div style="z-index:999; border:1px solid var(--darker); border-radius:30px; padding:8px 25px; font-size:13px; font-weight:600; text-align:center; background : var(--darker); color:white; width:70%; margin:0 auto 10px; ">
                    Income - Expenditure
                </div>
                    ...
                    <tr>
                        ...
                        <td style="padding:10px 20px 0 15px;">
                            <div class="form-check form-switch">
                                <input class="form-check-input" onclick ="box();" onchange="box();" type="checkbox" id="inex" style="border:none;" checked />
                            </div>
                        </td>
                        <td>Expenditure</td>
                    </tr>
                ...
                <div class="input-group mb-3" id="inbox" style="display:none;">
                    ...
                    <select class="form-select form-select-md " id="partid1" aria-label=".form-select-lg example" style=" background:var(--lighter);">
                        ...
                        {while($row0 = $result0->fetch_assoc()) { $id1 = $row0["id"]; $txt1 = $row0["particulareng"]; 
                ...
                <div class="input-group mb-3"  id="exbox" style="display:flex">
                    ...
                    <select class="form-select form-select-md " id="partid2" aria-label=".form-select-lg example" style=" background:var(--lighter);">
                        ...
                        $result0 = $conn->query($sql0);
                        if ($result0->num_rows > 0) 
                        {while($row0 = $result0->fetch_assoc()) { $id2 = $row0["id"]; $txt2 = $row0["particulareng"]; 
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="date" id="date" class="form-control" placeholder="Description" aria-label="Description" aria-describedby="basic-addon1" style=" background:var(--lighter);">
                </div>       
                
                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1"><i class="bi bi-file-text-fill"></i></span>
                    <input type="text" id="descrip" class="form-control" placeholder="Description" aria-label="Description" aria-describedby="basic-addon1">
                </div>       
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" id="amount" style="text-align:right;" class="form-control" placeholder="Amount" aria-label="Description" aria-describedby="basic-addon1">
            ...
            <div id="entrybox2" style="margin:15px; display:none;">
                ...
                <div class="input-group mb-3"  id="bank" style="display:flex">
                    <span class="input-group-text" id="basic-addon1"><i class="bi bi-dash-circle-fill"></i></span>
                    <select class="form-select form-select-md " id="bank2" aria-label=".form-select-lg example" style=" background:var(--lighter);">
                        <?php
                ...
                <div class="input-group mb-3"  id="exbox">
                    <span class="input-group-text" id="basic-addon1"><i class="bi bi-dash-circle-fill"></i></span>
                    <select class="form-select form-select-md " id="type2" aria-label=".form-select-lg example" style=" background:var(--lighter);">
                ...
                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1"><i class="bi bi-calendar3"></i></span>
                    <input type="date" id="date2"  value="<?php echo date('Y-m-d');?>"  class="form-control" placeholder="Description" aria-label="Description" aria-describedby="basic-addon1" style=" background:var(--lighter);">
                </div>       
                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1"><i class="bi bi-calendar3"></i></span>
                    <input type="text" id="chqno2"  value=""  class="form-control" placeholder="Cheque/Slip No." aria-label="chqno" aria-describedby="basic-addon1" style=" background:var(--lighter);">
                </div>       
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" id="amount2" style="text-align:right;" class="form-control" placeholder="Amount" aria-label="Description" aria-describedby="basic-addon1">
                    <span class="input-group-text" id="basic-addon1">.00</span>
                </div>    
