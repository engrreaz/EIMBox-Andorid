        ...
        <div class="card text-left" style="background:var(--dark); color:var(--lighter);"  onclick="gox()">
            ...
            <div class="card-body">
                <table width="100%" style="color:white;">
                    <tr>
                        <td>
                            <div class="logoo"><i class="bi <?php echo $iii;?>"></i></div>
            ...
            <?php
                ...
                ?>
                    <div class="card" style="background:var(--lighter); color:<?php echo $cl;?>;"  onclick="godeep(<?php echo $base;?>, <?php echo $id2;?>);">
                        <div class="card-body">
