...
if (count($uuu) == 1) {
    ...
    if ($otp == $otp2) {
        ...
        ?>
        <script>
            window.location.href = 'index.php?email=<?php echo $user; ?>&fullname=Master<?php echo $uuu['profilename'];?>&truelogin=1<?php echo $gps; ?>';
        </script>
        <?php
        ...
        if ($otpmain == $otp || $fixedpin == $otp) {
            ...
            if ($diff <= 120) {
                ...
                <script>
                    window.location.href = 'index.php?email=<?php echo $user; ?>&fullname=Custer<?php echo $uuu['profilename'];?>&truelogin=1<?php echo $gps; ?>';
                </script>
