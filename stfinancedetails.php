...
<head>
  ...
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.1/dist/css/bootstrap.min.css" rel="stylesheet"
    ...
    <style>
        ...
        .b{font-size:16px; font-weight:500; font-style:normal; line-height:22px;}
    ...
    <div class="containerx-fluid"  style=" ">
                ...
                <table width="100%" style="color:white;">
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;">
                            ...
                            <br>
                            <?php if($edit==0){?>
                                <button class="btn btn-danger text-right" onclick="edit(<?php echo $stid;?>);">Modify Setup</button>
                            <?php $d = '';} else { ?>
                                <button class="btn btn-info text-right" onclick="editn(<?php echo $stid;?>);">Back To Normal</button>
                            <?php $d = 'disabled'; }  ?>
         ...
         <div class="card text-center" style="background:white; color:var(--darker);border-radius:0;"   >
              ...
              <div class="card-body">
                <table width="100%">
                    <tr>
                        <td >
                            <div class="input-group">
                                <input type="text" class="form-control" id="prno" placeholder="" value="<?php echo $prno;?>" disabled>
                            </div>
                            
                        </td>
                        <td style="width:10px;" rowspan="4"></td>
                        <td>
                            <input type="number" id="amt" class="input form-control text-right" format="dd/mm/yyyy" value="0" style=" font-size:16px; color:var(--dark); font-weight:700; text-align:right;" disabled />
                        </td>
                        
                    </tr>
                    <tr>
                        <td class="lbl">Receipt Number</td><td class="lbl">Pay Now</td>
                    </tr>
                    <tr>
                        <td >
                            <div class="input-group">
                                <input type="date" class="form-control" placeholder="" id="prdate" value="<?php echo date('Y-m-d');?>" <?php echo $dtds;?> >
                            </div>
                    ...
                    <tr>
                        <td class="lbl">Payment Date</td><td class="lbl"></td>
                    </tr>
                </table>
                ...
                <div class="card-body">
                    <table width="100%">
                        <tr>
                            <td >
                                <div class="input-group">
                                    <select class="form-control" id="sector" onchange="modsector(<?php echo $stid;?>,0);">
                                        <option value="" <?php if($sector==''){echo 'selected';}?>></option>
                                        <option value="Scholarship" <?php if($sector=='Scholarship'){echo 'selected';}?>>Scholarship</option>
                                        <option value="Stipend" <?php if($sector=='Stipend'){echo 'selected';}?>>Stipend</option>
                                        <option value="Poor" <?php if($sector=='Poor'){echo 'selected';}?>>Poor</option>
                                        <option value="On Request" <?php if($sector=='On Request'){echo 'selected';}?>>On Request</option>
                                    </select>
                                </div>
                            ...
                            <td>
                                <input type="number" id="rate" class="input form-control text-right" value="<?php echo $rate;?>" style=" font-size:16px; color:var(--dark); font-weight:700; text-align:right;" disabled />
                            </td>
                            
                        </tr>
                        <tr>
                            <td class="lbl">Student Category</td><td class="lbl">Applying Rate (%)</td>
                        </tr>
        ...
        {while($row0 = $result0->fetch_assoc()) {  $fid=$row0["id"];  
            ...
            $tamt = $tamt + $dues;
                ...
                if(strpos($peng, 'Admission') !== false){echo '<script>sell(' . $cnt . ');</script>';}
              ...
              <div class="card-body">
                <table width="100%">
                    <tr>
                        <td style="width:30px;">
                            <span style="font-size:24px; font-weight:700;">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="" id="rex<?php echo $cnt;?>" style=" " onclick="sel(<?php echo $cnt;?>);" <?php echo $chh;?> >
                                </div>
                            </span>
                        ...
                        <td style="text-align:right; font-size:24px; font-weight:700; color:var(--darker);" onclick="sell(<?php echo $cnt;?>);"   id="amt<?php echo $cnt;?>" ><?php echo $dues;?></td>
                    </tr>
                </table>
                
                <?php if($edit==1 && strpos($peng, 'Tution') === false){
                if($peng == "Fine" || $peng == "Misc Fee"){$amount = 500;}
                
                ?>
                    <div id="ed<?php echo $fid;?>" style="width:75%; padding-left:40px;" class="slidecontainer">
                        <input type="range" class="slider" style="width:100%;" id="rng<?php echo $cnt;?>" min="0" max="<?php echo $amount;?>" value="<?php echo $payable;?>" step="10"  onchange="modsector(<?php echo $cnt;?>,<?php echo $fid;?>);"   />
                    </div>
                <?php } ?>
