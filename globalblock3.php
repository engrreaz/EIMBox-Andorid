...
if($stid*1<1000 || $stid==''){
        ...
        <div class="box">
            <?php if($sh == 0){ ?>
              ...
              <?php } ?>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="gray" class="bi bi-person-fill" viewBox="0 0 16 16">
       ...
       <div class="modal-dialog">
           <div class="modal-content">
               ...
               <div class="modal-footer">
                   <div id="check2"></div>
                   <button type="button" class="btn btn-info" data-bs-dismiss="modalx" onclick="submitstudent();">Verify Your Info</button>
               </div>
