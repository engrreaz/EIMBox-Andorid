  ...
  <main>
    <div class="containerx-fluid">
        <div class="card text-left" style="background:var(--dark); color:var(--lighter);border-radius:0; "  onclick="gol(<?php echo $id;?>)">
            ...
            <div class="card-body" style="border-radius:0;">
                <table width="100%" style="color:white;">
                    <tr>
                        <td colspan="2">
                            <div style="font-size:20px; text-align:center; padding: 2px 2px 8px; font-weight:700; line-height:15px;">Account Summery
                    ...
                    <tr>
                        <td>
                            <div style="font-size:16px; font-weight:700; line-height:15px;"><?php echo date('d-m-Y',strtotime($td));?></div>
        ...
        */
        ...
        $sql0 = "SELECT * FROM bankinfo where  status=1 order by id";
        //echo $sql0; 
        $result0 = $conn->query($sql0);
        if ($result0->num_rows > 0) 
        {while($row0 = $result0->fetch_assoc()) { 
            $id=$row0["id"]; $type=$row0["acctype"]; $accno=$row0["accno"];  $bankname=$row0["bankname"];   $branch=$row0["branch"];  
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td style="text-align:left; padding-left:5px;">
                            <div style="font-size:15px; font-weight: 700; color:<?php echo $bgc;?>"><?php echo $bankname . ' (' . $type . ')';?></div>
                            <div style="font-size:11px; font-weight: 400; color:<?php echo $bgc;?>">Account No. <?php echo $accno;?></div>
