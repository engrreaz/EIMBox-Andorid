        ...
        <div class="box">
            <?php if($sh == 0){ ?>
              <div class="right" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#setguardianbox">
               ...
               <?php } ?>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="gray" class="bi bi-people-fill" viewBox="0 0 16 16">
       ...
       <div class="modal-dialog">
           <div class="modal-content">
               ...
               <div class="modal-footer">
                   <div id="check"></div>
                   <button type="button" class="btn btn-info" data-bs-dismiss="modalx" onclick="submitguar();">Verify Your Info</button>
               </div>
