...
$cur = date('Y-m-d H:i:s');; $sy = date('Y');
    ...
    $cls=$row00xgr["areaname"]; $sec=$row00xgr["subarea"];}}
	...
	<div style="color:green; font-weight:bold; padding-top:5px;">
	    <i class="material-icons ico">done_all</i> ID has been generated.
	</div>